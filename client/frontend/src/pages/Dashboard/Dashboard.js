...
const Dashboard = ({ loadCharts, gradeDistExample, averageGradeDistExample, countyGradeDistExample }) => {
  ...
  return <Box>
    ...
    <Grid container>
      <Grid item xs={ 12 }>
        <TitleBox title={ 'Titlu principal' }>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed suscipit aliquet ultricies. Orci varius
            natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Duis faucibus purus ac justo
            dictum, quis finibus purus dignissim. Morbi venenatis non elit eget tincidunt. In quis dapibus orci, sit
            amet pretium turpis. Curabitur malesuada, magna vitae mattis pellentesque, ligula arcu sodales odio, quis
            consequat elit magna posuere nisl. Nam scelerisque dui a luctus faucibus. Curabitur vestibulum orci vitae
            imperdiet commodo.
          </p>
      ...
      <Grid item xs={ 12 } md={ 6 }>
        <ArticleBox title={ 'Titlu articol' }>
          ...
          <p>
            Vestibulum posuere erat quam, eget iaculis libero porta ut. Pellentesque habitant morbi tristique senectus
            et netus et malesuada fames ac turpis egestas. Sed quis dui eu velit egestas blandit vel a nunc. Lorem ipsum
            dolor sit amet, consectetur adipiscing elit. Aliquam pellentesque sodales lorem eget venenatis.
          </p>
          <p>
            Vestibulum posuere erat quam, eget iaculis libero porta ut. Pellentesque habitant morbi tristique senectus
            et netus et malesuada fames ac turpis egestas. Sed quis dui eu velit egestas blandit vel a nunc. Lorem ipsum
